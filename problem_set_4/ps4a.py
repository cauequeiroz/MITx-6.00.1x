...
def isValidWord(word, hand, wordList):
    ...
    """
    wordIsInWordList = word in wordList
    wordIsInHand = True
    ...
    return wordIsInWordList and wordIsInHand
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    if user_input == '.':
        final_status = 'Goodbye!'
    else:
        final_status = 'Run out of letters.'

    print(final_status + ' Total score: '+ str(score) +' points.')
